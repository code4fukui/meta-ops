...
BRANCH = 'review-readme-20260317-24'
...
EXCLUDE = {
    ...
    'numfont8','obama-kanko-reservation','object-store','object2youtube','ocr_mac'
}
...
def process_repo(repo: Path):
    ...
    # Never add English pointer line in JA README.
...
print(f'SUMMARY|ok={ok}|branch={BRANCH}')
